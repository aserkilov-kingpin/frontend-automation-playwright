...
from core.interfaces.portal.portal_base_interface import PortalBaseInterface

log = LogHandler.get_module_logger(__name__)


class PortalClient(SessionAuthBase, PortalBaseInterface):
    _SESSION_URI = "/users/login"
